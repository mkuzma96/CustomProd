...
for theta in thetas:
    ...
    for wd_param in [0.8,0.9,1,1.1,1.2]:
        ...
        file_name = "theta_" + str(theta) + "_run_" + str(run) + "_" + nonlin + "_" + error + "_alpha_" + str(wd_param) + "_pred_results.npz"
        np.savez(file_name, y_true=y_test, adversarial=y_pred_wdgrl)
