...
for theta in [1,2,3,4]:
    ...
    for wd_param in [0.8,0.9,1,1.1,1.2]:
    
        pred_path = "theta_" + str(theta) + "_run_" + str(run) + "_" + nonlin + "_" + error + "_alpha_" + str(wd_param) + "_pred_results.npz"
        ...
        file_name = "theta_" + str(theta) + "_run_" + str(run) + "_" + nonlin + "_" + error + "_alpha_" + str(wd_param) + "_capacity_" + str(capacity) + "_cost-ratio_" + str(ratio) +  "_final_results.csv"  
